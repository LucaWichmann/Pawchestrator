...
GENERATED_BY_FOOTER = (
    "---\n"
    "<sub>Generated by "
    "[Pawchestrator](https://github.com/LucaWichmann/Pawchestrator)</sub>"
)
GENERATED_BY_FOOTER_RE = re.compile(
    r"(?:\r?\n)*---\r?\n"
    r"<sub>Generated by "
    r"\[Pawchestrator\]\(https://github\.com/LucaWichmann/Pawchestrator\)"
    r"</sub>\s*$"
)
...
def without_generated_attribution(body: str) -> str:
    return GENERATED_BY_FOOTER_RE.sub("", body).rstrip()


def with_generated_attribution(body: str) -> str:
    stripped = without_generated_attribution(body)
    if not stripped:
        return GENERATED_BY_FOOTER
    return f"{stripped}\n\n{GENERATED_BY_FOOTER}"
